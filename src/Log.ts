...
export class Log {
    ...
    public static Configure(config: ConfigLogging) {
        // Merge defaults.
        Log.config = Object.assign(new ConfigLogging(), config);
        Log.setupLogger();
    }
    ...
    private static config: ConfigLogging;
